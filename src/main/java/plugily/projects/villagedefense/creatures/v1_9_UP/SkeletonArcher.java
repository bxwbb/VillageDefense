 ...
 */
public class SkeletonArcher implements SimpleEnemySpawner {
    ...
    public SkeletonArcher(Main plugin) {
        this.plugin = plugin;
    }
    ...
    public Creature spawn(Location location) {
        ...
        skeleton.setMetadata("PlugilyProjects-VillageDefense-Name", new FixedMetadataValue(plugin, "SkeletonArcher"));
        return skeleton;
    }
