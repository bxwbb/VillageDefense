 ...
 */
public class NormalWitherSkeleton implements SimpleEnemySpawner {

    private final Main plugin;

    public NormalWitherSkeleton(Main plugin) {
        this.plugin = plugin;
    }
    ...
    public LivingEntity spawn(Location location) {
        WitherSkeleton witherSkeleton = (WitherSkeleton) VersionUtils.spawnEntity(location, EntityType.WITHER_SKELETON);
        witherSkeleton.getEquipment().setHelmet(new ItemStack(Material.AIR));
        witherSkeleton.getEquipment().setHelmetDropChance(0f);
        witherSkeleton.getEquipment().setChestplate(new ItemStack(Material.AIR));
        witherSkeleton.getEquipment().setChestplateDropChance(0f);
        witherSkeleton.getEquipment().setLeggings(new ItemStack(Material.AIR));
        witherSkeleton.getEquipment().setLeggingsDropChance(0f);
        witherSkeleton.getEquipment().setBoots(new ItemStack(Material.AIR));
        witherSkeleton.getEquipment().setBootsDropChance(0f);
        witherSkeleton.getEquipment().setItemInMainHand(new ItemStack(Material.AIR));
        witherSkeleton.getEquipment().setItemInMainHandDropChance(0F);
        assert XAttribute.FOLLOW_RANGE.get() != null;
        Objects.requireNonNull(witherSkeleton.getAttribute(XAttribute.FOLLOW_RANGE.get())).setBaseValue(200D);
        witherSkeleton.setRemoveWhenFarAway(false);
        witherSkeleton.setMetadata("PlugilyProjects-VillageDefense-Name", new FixedMetadataValue(plugin, "NormalWitherSkeleton"));
