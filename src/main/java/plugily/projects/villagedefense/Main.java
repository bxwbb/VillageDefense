...
import plugily.projects.villagedefense.arena.managers.RoomSelectorManager;
...
public class Main extends PluginMain {
    ...
    public void initializePluginClasses() {
        ...
        networkRoomManager = new NetworkRoomManager(this);
        new RoomSelectorManager(this);
    ...
    public void addKits() {
        ...
        optionalConfigurations.add("skills");
        optionalConfigurations.add("skill");
        ...
        getKitRegistry().setDefaultKit("warrior");
    ...
    public NetworkRoomManager getNetworkRoomManager() {
        return networkRoomManager;
    }
