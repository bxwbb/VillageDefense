...
public class MessageInitializer {
    ...
    public void registerMessages() {
        ...
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_WAVE_TIMEOUT", new Message("In-Game.Messages.Village.Wave.Timeout", ""));
        /*unused*/
        ...
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_WAVE_ENTITIES_PILLAGER_SPAWN", new Message("In-Game.Messages.Village.Entities.Pillager.Spawn", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_WAVE_ENTITIES_PILLAGER_NAME", new Message("In-Game.Messages.Village.Entities.Pillager.Name", ""));
        ...
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_LEATHER", new Message("In-Game.Messages.Village.Shop.Leather", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_STONE", new Message("In-Game.Messages.Village.Shop.Stone", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_IRON", new Message("In-Game.Messages.Village.Shop.Iron", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_DIAMOND", new Message("In-Game.Messages.Village.Shop.Diamond", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_NETHERITE", new Message("In-Game.Messages.Village.Shop.Netherite", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_TRIDENT", new Message("In-Game.Messages.Village.Shop.Trident", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_ENCHANTED_TRIDENT", new Message("In-Game.Messages.Village.Shop.Enchanted-Trident", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_ULEATHER", new Message("In-Game.Messages.Village.Shop.ULeather", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_USTONE", new Message("In-Game.Messages.Village.Shop.UStone", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_UIRON", new Message("In-Game.Messages.Village.Shop.UIron", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_UDIAMOND", new Message("In-Game.Messages.Village.Shop.UDiamond", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_UNETHERITE", new Message("In-Game.Messages.Village.Shop.UNetherite", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_UTRIDENT", new Message("In-Game.Messages.Village.Shop.UTrident", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_UENCHANTED_TRIDENT", new Message("In-Game.Messages.Village.Shop.UEnchanted-Trident", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_SEPARATOR", new Message("In-Game.Messages.Village.Shop.Separator", ""));
        getMessageManager().registerMessage("IN_GAME_MESSAGES_VILLAGE_SHOP_ITEM_CTRL_LORE", new Message("In-Game.Messages.Village.Shop.Item-Ctrl-Lore", ""));
